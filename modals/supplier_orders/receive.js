...
export default function ReceiveModal({
  ...
  // console.log(data.purchaseHeader.purchase_header_id);
    ...
    const handleSubmit = async (e) => {
      ...
      // // Filter the purchaselines to those not part of the ids located in the rowIds
      // const filteredArray = data.purchaseLines.filter(purchaseLine => !rowIdSelection.some(id => purchaseLine.purchase_line_id === id));
